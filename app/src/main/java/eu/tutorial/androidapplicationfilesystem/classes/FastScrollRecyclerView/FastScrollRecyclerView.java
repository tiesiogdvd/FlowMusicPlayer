...
public class FastScrollRecyclerView extends RecyclerView implements RecyclerView.OnItemTouchListener {
    ...
    private eu.tutorial.androidapplicationfilesystem.classes.FastScrollRecyclerView.FastScroller mScrollbar;
    ...
    public FastScrollRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mScrollbar = new eu.tutorial.androidapplicationfilesystem.classes.FastScrollRecyclerView.FastScroller(context, this, attrs);
    ...
    protected void updateThumbPosition(ScrollPositionState scrollPosState, int rowCount) {
        ...
        availableScrollBarHeight = getAvailableScrollBarHeight() + getPaddingBottom();
        ...
        // padding)
        int scrollY = Math.min(availableScrollHeight, getPaddingBottom() + scrolledPastHeight);
        ...
        if (isLayoutManagerReversed()) {
            ...
            scrollBarY = scrollBarY - getPaddingTop();
        }
