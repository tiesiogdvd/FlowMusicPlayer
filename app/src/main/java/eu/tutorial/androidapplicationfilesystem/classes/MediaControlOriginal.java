...
public class MediaControlOriginal extends AppCompatActivity {

    NeumorphImageButton btnPlay;
    NeumorphImageButton btnPlay1;
    ...
    public MediaControlOriginal(Context context) {
        ...
        this.btnPlay1 = ((MainActivity)context).findViewById(R.id.playButton);
