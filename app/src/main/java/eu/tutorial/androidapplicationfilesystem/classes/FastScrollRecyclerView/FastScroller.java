...
public class FastScroller {
    ...
    @Retention(SOURCE)
    @IntDef({FastScroller.PopupTextVerticalAlignmentMode.TEXT_BOUNDS, FastScroller.PopupTextVerticalAlignmentMode.FONT_METRICS})
    public @interface PopupTextVerticalAlignmentMode {
        int TEXT_BOUNDS = 0;
        int FONT_METRICS = 1;
    }
    @IntDef({FastScroller.PopupPosition.ADJACENT, FastScroller.PopupPosition.CENTER})
    ...
    public FastScroller(Context context, FastScrollRecyclerView recyclerView, AttributeSet attrs) {
        ...
        try {
            ...
            @com.simplecityapps.recyclerview_fastscroll.views.FastScroller.PopupTextVerticalAlignmentMode int popupTextVerticalAlignmentMode = typedArray.getInteger(R.styleable.FastScrollRecyclerView_fastScrollPopupTextVerticalAlignmentMode, com.simplecityapps.recyclerview_fastscroll.views.FastScroller.PopupTextVerticalAlignmentMode.TEXT_BOUNDS);
            @com.simplecityapps.recyclerview_fastscroll.views.FastScroller.PopupPosition int popupPosition = typedArray.getInteger(R.styleable.FastScrollRecyclerView_fastScrollPopupPosition, com.simplecityapps.recyclerview_fastscroll.views.FastScroller.PopupPosition.ADJACENT);
    ...
    public void draw(Canvas canvas) {
        ...
        rect.set(mThumbPosition.x + mOffset.x + (mThumbWidth - mTrackWidth),
                ...
                mThumbPosition.x + mOffset.x + mThumbWidth + (mThumbWidth - mTrackWidth),
    ...
    public void setPopupPosition(@com.simplecityapps.recyclerview_fastscroll.views.FastScroller.PopupPosition int popupPosition) {
        mPopup.setPopupPosition(popupPosition);
    }
