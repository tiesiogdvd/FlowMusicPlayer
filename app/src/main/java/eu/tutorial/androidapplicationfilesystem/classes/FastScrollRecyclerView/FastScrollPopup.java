package eu.tutorial.androidapplicationfilesystem.classes.FastScrollRecyclerView;
//Modified in this music player project to fix the problem of scrollbar not matching
//fingers' location after setting bottom padding for recyclerview
...
public class FastScrollPopup {
    ...
    @com.simplecityapps.recyclerview_fastscroll.views.FastScroller.PopupTextVerticalAlignmentMode private int mTextVerticalAlignmentMode;
    @com.simplecityapps.recyclerview_fastscroll.views.FastScroller.PopupPosition private int mPosition;
    ...
    public void setPopupTextVerticalAlignmentMode(@com.simplecityapps.recyclerview_fastscroll.views.FastScroller.PopupTextVerticalAlignmentMode int mode) {
        mTextVerticalAlignmentMode = mode;
    }

    @com.simplecityapps.recyclerview_fastscroll.views.FastScroller.PopupTextVerticalAlignmentMode
    public int getPopupTextVerticalAlignmentMode() {
        return mTextVerticalAlignmentMode;
    }

    public void setPopupPosition(@com.simplecityapps.recyclerview_fastscroll.views.FastScroller.PopupPosition int position) {
        mPosition = position;
    }

    @com.simplecityapps.recyclerview_fastscroll.views.FastScroller.PopupPosition
    public int getPopupPosition() {
        return mPosition;
    }

    private float[] createRadii() {
        if (mPosition == com.simplecityapps.recyclerview_fastscroll.views.FastScroller.PopupPosition.CENTER) {
    ...
    public void draw(Canvas canvas) {
        if (isVisible()) {
            ...
            if (mTextVerticalAlignmentMode == com.simplecityapps.recyclerview_fastscroll.views.FastScroller.PopupTextVerticalAlignmentMode.FONT_METRICS) {
