...
import eu.tutorial.androidapplicationfilesystem.adapters.AdapterPlaylistsDialogLibrary;

public class DialogPlaylistLibrary {
    private ViewModelMain viewModelMain;

    public void createDialog(Context context, ArrayList <Playlist> playlists, ArrayList<MusicData> songs) {
        ...
        recyclerView.setAdapter(new AdapterPlaylistsDialogLibrary(context, playlists, songs));
